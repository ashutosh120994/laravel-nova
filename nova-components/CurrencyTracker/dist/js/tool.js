...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getRates: function getRates() {
            ...
            Nova.request().get('/nova-vendor/currency-tracker/rates').then(function (response) {
                var result = JSON.parse(response.data);
                console.log(result);
                var cus = result['rates'];
                var allowed = ['USD', 'GBP', 'EUR'];
                _this.rates = allowed.reduce(function (result, key) {
                    return _extends({}, result, _defineProperty({}, key, cus[key]));
                }, {});
            });
        }
    }
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "w-full" },
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Currency Tracker")]),
      _vm._v(" "),
